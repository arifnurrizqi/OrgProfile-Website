	...
	<div class="container">
		...
		<form action="" method="post" style="max-width: 600px;">
			<div>
				...
				<div class="text-sm font-semibold flex"><span class="font-bold text-rose-500">*</span><?= form_error('name') ?></div>
			</div>
			<div>
				...
				<div class="text-sm font-semibold flex"><span class="font-bold text-rose-500">*</span><?= form_error('email') ?></div>
			</div>
			<div>
				...
				<div class="text-sm font-semibold flex"><span class="font-bold text-rose-500">*</span><?= form_error('message') ?></div>
			</div>
