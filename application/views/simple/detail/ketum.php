...
<section id="home" class="min-h-screen flex items-center px-10 dark:bg-dark">
  <div class="container relative isolate">
    ...
    <h1 class="text-3xl lg:text-4xl font-extrabold  uppercase text-dark text-center dark:text-white">Presiden <span class="text-primary">& Wakil Presiden</span>
    </h1>
  ...
  <div class="container">
    <div class="w-full px-4">
      <div class="mx-auto mb-8 max-w-xl text-center">
        ...
        <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-4xl">Lingkar Presiden</h2>
      </div>
    </div>
    <div class="w-full">
      <!-- Press wapress -->
