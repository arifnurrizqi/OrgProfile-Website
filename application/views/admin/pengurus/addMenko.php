...
<body>
	<main class="max-w-7xl max-w mx-auto flex lg:py-5 pb-32 px-4 pt-4 lg:gap-8">
		...
		<div class="flex flex-col w-full right-0">
			...
			<h1 class="text-xl font-bold lg:mb-2.5">Tambah Menteri Koordinator</h1>

			<form action="<?= base_url() ?>admin/pengurus/submit_addMenko" method="POST" enctype="multipart/form-data">
				<div>
				...
				<div>
					<label for="jabatan" class="w-full font-medium text-gray-900 dark:text-white">Kementerian Koordinator</label>
					<input type="text" name="jabatan" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan nama kemenkoan, misal 'Manajemen Kabinet atau yang lainnya'" value="" required />
				</div>
				<div class="w-full">
					<label for="about" class="w-full font-medium text-gray-900 dark:text-white">Tentang Kemenkoan</label>
					<textarea type="text" name="about" rows="8" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan tentang Kemenkoan" required></textarea>
				</div>
				<div id="sosmed">
