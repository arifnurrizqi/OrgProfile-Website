  ...
  <main class="max-w-7xl max-w mx-auto flex lg:py-5 pb-32 px-4 pt-4 lg:gap-8">
    ...
    <div class="flex flex-col w-full right-0">
      ...
      <div class="p-4 rounded-xl border-2 mb-4">
        ...
        <form action="<?= base_url() ?>admin/pengurus/submit_editMenteri" method="POST" enctype="multipart/form-data">
          <div>
          ...
          <div class="w-full">
            ...
            <textarea type="text" name="about" rows="8" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan tentang Kementerian" required><?= $pengurus->about; ?></textarea>
          </div>
          <div id="sosmed">
      ...
      <div class="p-4 rounded-xl border-2 mb-4">
        ...
        <form action="<?= base_url() ?>admin/pengurus/submit_editPosition" method="POST">
          <div>
            ...
            <input type="hidden" name="id_landing" value="<?= $landing->id; ?>">
            <input type="hidden" name="id_pengurus" value="<?= $pengurus->id; ?>">
            <select name="jabatan_ref" id="" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2 mt-1 mb-3" required>
          ...
          <div>
            ...
            <input type="text" name="jabatan" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan nama kementerian" value="<?= $pengurus->jabatan; ?>" required />
          </div>
          <div class="flex gap-3 mt-3">
            <button type="submit" name="save" class="bg-primary py-2 px-3 text-center rounded-lg text-white mt-2">Simpan</button>
          </div>
