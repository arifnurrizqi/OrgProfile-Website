...
<body>
  <main class="max-w-7xl max-w mx-auto flex lg:py-5 pb-32 px-4 pt-4 lg:gap-8">
    ...
    <div class="flex flex-col w-full right-0">
      ...
      <form action="<?= base_url() ?>admin/pengurus/submit_editKetum" method="POST" enctype="multipart/form-data">
        <div>
          ...
          <input type="text" name="namaKetum" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan nama lengkap" value="<?= $pengurus->nama; ?>" required />
        </div>
        <div>
          <label for="prodiKetum" class="w-full font-medium text-gray-900 dark:text-white">Program Studi</label>
          <input type="text" name="prodiKetum" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan program studi" value="<?= $pengurus->prodi; ?>" required />
        </div>
        <div>
          <label for="angkatanKetum" class="w-full font-medium text-gray-900 dark:text-white">Angkatan</label>
          <input type="text" name="angkatanKetum" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5 mt-1 mb-4" placeholder="Masukan tahun angkatan" value="<?= $pengurus->angkatan; ?>" required />
        </div>
        <div id="sosmed">
          ...
          <div class="flex mt-1 mb-4">
            ...
            <input type="text" name="igKetum" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5" placeholder="Masukan username instagram" value="<?= $pengurus->ig; ?>" />
          </div>
          <div class="flex mt-1 mb-4">
            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-l-lg border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
            ...
            <input type="text" name="ttKetum" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5" placeholder="Masukan username tiktok" value="<?= $pengurus->tiktok; ?>" />
          </div>
          <div class="flex mt-1 mb-4">
            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-l-lg border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
            ...
            <input type="text" name="fbKetum" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5" placeholder="Masukan username facebook" value="<?= $pengurus->fb; ?>" />
          </div>
          <div class="flex mt-1 mb-4">
            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border rounded-l-lg border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
            ...
            <input type="text" name="twiterKetum" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:border-primary focus:outline-none focus:ring-1 block w-full p-2.5" placeholder="Masukan username twiter" value="<?= $pengurus->twiter; ?>" />
          </div>
        </div>
        <div class="w-full flex flex-wrap mb-3">
          <div class="w-full md:w-2/3 flex flex-wrap mb-2">
            ...
            <input type="hidden" name="nama_fotoKetum" value="<?= $pengurus->foto ?>">
          ...
          <div class="w-full md:w-1/3 flex items-center justify-center">
            ...
            <img src="<?= $fotoPengurus ?>" alt="<?= htmlentities('Foto' . $pengurus->nama, TRUE) ?>" class="rounded-lg h-24 px-6">
          </div>
